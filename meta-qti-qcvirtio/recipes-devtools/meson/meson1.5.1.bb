...
# PN/PV must be set explicitly because the filename uses concatenated versioning
# (meson1.5.1.bb) rather than the standard underscore separator.
PN = "meson1.5.1"
PV = "1.5.1"
S = "${WORKDIR}/meson-${PV}"
...
FILESEXTRAPATHS:prepend := "${THISDIR}/meson1.5.1:"
...
do_install:append:class-native() {
    ...
    # We need to wrap the real meson with a thin wrapper that substitutes native/cross files
