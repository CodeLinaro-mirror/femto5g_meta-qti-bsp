SUMMARY = "QTI image for virtio"
DESCRIPTION = "QTI image for virtio suppport"
...
IMAGE_INSTALL:append = " ${@bb.utils.contains('DISTRO_FEATURES', 'qti-security', 'optee-libckteec', '', d)}"
